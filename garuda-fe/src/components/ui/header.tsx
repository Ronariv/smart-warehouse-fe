...
import UploadPage from "@/app/components/upload-page/page";

export default function Header() {
  const router = useRouter()

  return (
    <nav className="fixed inset-x-0 top-0 z-50 bg-white border shadow-sm text-white">
      <div className="w-full max-w-7xl px-4 mx-auto">
        <div className="flex justify-between h-14 items-center ml-auto">
          ...
          <div className="flex flex-row justify-between gap-4">
            <UploadPage />
            {/* must sign in or redirect to signin */}
